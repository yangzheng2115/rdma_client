...
WindowsPtpThreadPool::WindowsPtpThreadPool(size_t max_threads)
        : pool_{nullptr}, callback_environment_{nullptr}, cleanup_group_{nullptr}, max_threads_{max_threads} {
...
void CALLBACK
WindowsPtpThreadPool::TaskStartSpringboard(PTP_CALLBACK_INSTANCE
instance,
