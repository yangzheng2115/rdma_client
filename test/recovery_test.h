...
TEST(CLASS, Serial_VariableLengthKey) {
    ...
    public:
        ...
        ReadContext1(ReadContext1 &other)
                : key_{std::move(other.key_)}, val_{other.val_}, expected{other.expected} {
        }
...
TEST(CLASS, Concurrent_Insert_Small) {
    ...
    public:
        ...
        /// Copy (and deep-copy) constructor.
        ReadContext2(const ReadContext2 &other)
                : key_{other.key_}, val_{other.val_}, expected{other.expected}, idx{other.idx}, found{other.found} {
        }
