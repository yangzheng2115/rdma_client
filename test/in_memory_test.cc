...
TEST(InMemFaster, UpsertRead) {
    ...
    public:
        ...
        UpsertContext(uint8_t key) : key_{key} {
        }
    ...
    public:
        ...
        ReadContext(uint8_t key) : key_{key} {
        }
...
TEST(InMemFaster, UpsertDeleteRead) {
    ...
    public:
        ...
        Value(uint8_t value) : value_{value} {
        }
    ...
    public:
        ...
        DeleteContext(uint8_t key) : key_{key} {
        }
    ...
    /*for (size_t idx = 128; idx < 129; ++idx) {*/
    for (size_t idx = 127; idx < 128; ++idx) {
        auto callback = [](IAsyncContext *ctxt, Status result) {
            // In-memory test.
            ASSERT_TRUE(false);
        };
...
TEST(InMemFaster, UpsertRead_DummyHash) {
    ...
    public:
        ...
        UpsertContext(uint16_t key) : key_{key} {
        }
    ...
    public:
        ...
        ReadContext(uint16_t key) : key_{key} {
        }
...
TEST(InMemFaster, Rmw) {
    ...
    public:
        ...
        RmwContext(uint64_t key, int32_t incr) : key_{key}, incr_{incr} {
        }
...
TEST(InMemFaster, Rmw_Concurrent) {
    ...
    public:
        ...
        RmwContext(uint64_t key, int64_t incr) : key_{key}, incr_{incr} {
        }
...
TEST(InMemFaster, Rmw_ResizeValue_Concurrent) {
    ...
    public:
        ...
        RmwContext(uint64_t key, int8_t incr, uint32_t length) : key_{key}, incr_{incr}, length_{length} {
        }

        /// Copy (and deep-copy) constructor.
        RmwContext(const RmwContext &other) : key_{other.key_}, incr_{other.incr_}, length_{other.length_} {
        }
    ...
    public:
        ...
        ReadContext(uint64_t key) : key_{key}, output_length{0} {
        }
...
TEST(InMemFaster, Rmw_GrowString_Concurrent) {
    ...
    public:
        ...
        RmwContext(uint64_t key, char letter) : key_{key}, letter_{letter} {
        }

        /// Copy (and deep-copy) constructor.
        RmwContext(const RmwContext &other) : key_{other.key_}, letter_{other.letter_} {
        }
...
TEST(InMemFaster, ConcurrentDelete) {
    ...
    public:
        ...
        explicit RmwContext(const Key &key) : key_{key} {}
    ...
    public:
        ...
        explicit ReadContext(const Key &key) : key_{key} {}
...
TEST(InMemFaster, GrowHashTable) {
    ...
    public:
        ...
        RmwContext(const RmwContext &other)
                : key_{other.key_}, incr_{other.incr_} {
        }
